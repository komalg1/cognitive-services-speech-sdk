// <copyright file="StartTranscriptionEnvironmentVariablesOld.cs" company="Microsoft Corporation">
...
namespace StartTranscriptionByTimer
{
    ...
    public static class StartTranscriptionEnvironmentVariablesOld
    {
